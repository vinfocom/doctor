...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-gradient-to-br from-gray-50 to-indigo-50/30">
            ...
            {/* Background orbs */}
            <motion.div
                className="mobile-gpu-heavy absolute top-20 left-20 w-80 h-80 bg-indigo-200/30 rounded-full blur-3xl"
                animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }}
                transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
                className="mobile-gpu-heavy absolute bottom-20 right-20 w-96 h-96 bg-purple-200/20 rounded-full blur-3xl"
